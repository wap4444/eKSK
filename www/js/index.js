...
//  Для Iphone
 var ref = cordova.InAppBrowser.open(jsonData.notification.payload.additionalData.ssylka, '_blank', 'location=no,toolbar=no,disallowoverscroll=yes');
        ...
        window.plugins.OneSignal.getIds(function(ids) {
            ...
            if(rr==1)
            {
            var ref = cordova.InAppBrowser.open('http://smart-pavlodar.kz/ekibastuz/project_ksk/index.html?push='+ipush, '_blank', 'location=no,toolbar=no,disallowoverscroll=yes');
            }       
            });
